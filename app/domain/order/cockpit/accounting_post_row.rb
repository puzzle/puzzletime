  ...
  class Cockpit
    class AccountingPostRow < Row
      ...
      def build_supplied_services_cell
        build_cell_with_amount(supplied_services_hours, order_order_services_path(@order.id, work_item_ids: accounting_post.work_item.id, start_date: @period.start_date, end_date: @period.end_date))
      end
