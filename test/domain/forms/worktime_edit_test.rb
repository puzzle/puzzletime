...
module Forms
  class WorktimeEditTest < ActiveSupport::TestCase
    ...
    test 'may add new' do
      ...
      assert_empty wt.errors.full_messages
    ...
    test 'may not add additional hours' do
      ...
      assert_predicate wt.errors[:hours], :present?
      assert_empty edit.worktimes
    end
    ...
    test 'may add different date' do
      ...
      assert_predicate wt.errors[:work_date], :blank?
      assert_equal [wt], edit.worktimes
    end
    ...
    test 'worktime_template contains remaining hours' do
      ...
      assert_in_delta(0.5, edit.worktime_template.hours)
    end
