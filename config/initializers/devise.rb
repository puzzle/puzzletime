...
Devise.setup do |config|
  ...
  # config.secret_key = 'c2996c5a953b0b5c00b642679562ee32986f79c5a91060a50ea9980bd0b6a143c7c41143cd5915ffe9217295555c0f6c989495c51b9a043eeee47bce0ffac9d2'
  ...
  config.mailer_sender = 'time@puzzle.ch'
  ...
  config.authentication_keys = [:shortname]
  ...
  config.strip_whitespace_keys = [:shortname]
  ...
  # config.pepper = 'e0d110b51c4f6aaf1ac81a79ee5777bcba44ac3d24cb947ec9d5b6029636aba425bf65c47e0b5ffac43d90eb6b82e77777093e7777667d90f40608a8160a6d10'
  ...
  config.remember_for = 1.day # 2.weeks
  ...
  # end
  config.warden do |manager|
    manager.strategies.add(:personal_access_token, PersonalAccessTokenStrategy)
    manager.strategies.add(:api, Devise::Strategies::API)
    manager.default_strategies(scope: :employee).unshift(:personal_access_token, :api)
  end
