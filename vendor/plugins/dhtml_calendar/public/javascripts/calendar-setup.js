...
Calendar.setup = function (params) {
	...
	var tmp = ["inputField", "displayArea", "button", "help", "inputFieldDay", "inputFieldMonth", "inputFieldYear"];
	for (var i in tmp) {
	...
	if (!(params.flat || params.multiple || params.inputField || params.inputFieldDay || params.inputFieldMonth || params.inputFieldYear || params.displayArea || params.button)) {
